 ...
 * @version 191017
 */
public class ContractNetDefense extends ContractNetInitiator {
     ...
     */
    public ContractNetDefense(Agent agent, ACLMessage msg, final String _from, final String _to, final int _departure, final String _preference) {
        super(agent, msg);
        from = _from;
        to = _to;
    ...
    /**
     * Achat.setPerformative(ACLMessage.Cfp)
     * Intermediaire handleCfp()
     * Intermediaire.setPerformative(ACLMessage.
     *
     */
}
